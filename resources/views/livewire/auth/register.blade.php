...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-sm text-center text-hover leading-5 max-w">
            Have an Account?
        </p>
        <p class="mt-2 text-m text-center text-dark hover:text-hover dark:text-std dark:hover:text-hover leading-5 max-w">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-hover shadow-lg sm:rounded-lg sm:px-10">
            <form wire:submit.prevent="register">
                ...
                <div class="mt-6">
                    <span class="block w-full rounded-md shadow-sm">
                        <button type="submit" class="flex justify-center w-full px-4 py-2 text-sm font-medium
                            text-std bg-dark hover:bg-hover dark:text-std dark:bg-dark dark:hover:bg-std dark:hover:text-dark border border-transparent rounded-md hover:bg-indigo-500
