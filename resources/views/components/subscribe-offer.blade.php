<div class="bg-gradient-to-b from-violet to-hover">
    <div class="container m-auto px-6 py-20 md:px-12 lg:px-20">
        <div class="m-auto text-center lg:w-8/12 xl:w-7/12">
            <h2 class="text-2xl text-pink-900 font-bold md:text-4xl">Subscription gives you access to more.</h2>
        </div>
        <div class="mt-12 m-auto -space-y-4 items-center justify-center md:flex md:space-y-0 md:-space-x-4 xl:w-10/12">
            <div class="relative z-10 -mx-4 group md:w-6/12 md:mx-0 lg:w-5/12">
                <div aria-hidden="true" class="absolute top-0 w-full h-full rounded-2xl bg-std dark:bg-dark2 shadow-xl transition duration-500 group-hover:scale-105 lg:group-hover:scale-110"></div>
                <div class="relative p-6 space-y-6 lg:p-8">
                    <h3 class="text-3xl text-dark dark:text-std font-semibold text-center">Organisation</h3>
                    <div>
                        <div class="relative flex justify-around">
                            <div class="flex items-end">
                                <span class="text-8xl text-violet dark:text-violet font-bold leading-0">35</span>
                                <div class="pb-2">
                                    <span class="block text-2xl text-violet dark:text-violet font-bold">%</span>
                                    <span class="block text-xl text-violet dark:text-violet font-bold">Off</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <ul role="list" class="w-max space-y-4 py-6 m-auto text-dark dark:text-std">
                        <li class="space-x-2">
                            <span class="text-violet font-semibold">&check;</span>
                    ...
                    <p class="flex items-center justify-center space-x-4 text-lg text-dark dark:text-std text-center">
                    ...
                    <button type="submit" title="Submit" class="block w-full py-3 px-6 text-center rounded-xl transition bg-violet hover:bg-hover active:bg-dark2 focus:bg-violet">
            ...
            <div class="relative group md:w-6/12 lg:w-7/12">
                <div aria-hidden="true" class="absolute top-0 w-full h-full rounded-2xl bg-dark2 dark:bg-std shadow-lg transition duration-500 group-hover:scale-105"></div>
