<section class="pt-20 pb-24 2xl:py-40 bg-std dark:bg-dark">
    <div class="container mx-auto px-4">
      ...
      <div class="max-w-6xl mx-auto">
        <div class="flex flex-wrap items-center -mx-3">
          ...
          <div class="w-full lg:w-1/3 px-3 mb-8 lg:mb-0">
            <div class="px-12 py-16 bg-hover hover:bg-dark rounded-3xl">
              <div class="pb-8 mb-14 border-b border-dark">
                <div class="flex justify-between items-center px-3">
                  <h3 class="text-4xl text-white font-bold font-heading">Team</h3>
                  <p class="text-lg text-white font-bold">ZAR 149</p>
                </div>
              </div>
              <ul class="text-lg text-white mb-16">
                <li class="flex items-center mb-8">
