<div class="flex items-center justify-center min-h-screen bg-white min-w-screen">
    <div class="flex flex-col-reverse items-center justify-center mx-auto lg:flex-row lg:max-w-4xl lg:p-0">
        ...
        <div class="px-5 md:w-2/3 lg:w-1/2">
            <img src="https://images.unsplash.com/photo-1554244933-d876deb6b2ff?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1480&q=80"
