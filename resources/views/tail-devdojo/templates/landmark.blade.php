...
<body class="overflow-x-hidden antialiased">
    ...
    <header class="relative z-50 w-full h-24">
        <div
            ...
            <a href="/" class="relative items-center inline-block h-full font-black leading-none">
            ...
            <nav id="nav"
                ...
                <div class="flex-col block w-full font-medium border-t border-gray-200 md:hidden">
            ...
            <div
                ...
                <a href="#_"
                    class="relative z-40 inline-block w-auto h-full px-5 py-3 text-sm font-bold leading-none text-white transition-all duration-300 bg-indigo-700 rounded shadow-md fold-bold lg:bg-white lg:text-indigo-700 sm:w-full lg:shadow-none hover:shadow-xl">Get
                    Started</a>
    ...
    <div class="relative px-8 py-10 bg-white border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        ...
        <div id="pricing" class="container flex flex-col items-center h-full max-w-6xl mx-auto">
            ...
            <div class="max-w-full mx-auto md:max-w-6xl sm:px-8">
                <!-- Basic Pricing -->
                <div class="relative flex-col items-center block sm:flex-row">
                    <div
                        ...
                        <div class="overflow-hidden text-black bg-white border-t border-gray-100 rounded-lg shadow-sm">
                            ...
                            <div class="items-center block p-8 uppercase">
                                <a href="#_"
                    ...
                    <div
                        ...
                        <div class="overflow-hidden text-black bg-white rounded-lg shadow-inner">
                            <div
            ...
            <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
                ...
                <div class="flex flex-col w-full text-gray-700">
                    ...
                    <div class="flex justify-start pl-4 mt-2">
                        <a class="items-center block mr-6 text-gray-400 no-underline hover:text-gray-600"
                        ...
                        <a class="items-center block text-gray-400 no-underline hover:text-gray-600"
                            target="_blank" rel="noopener noreferrer" href="https://devdojo.com">
                            <svg viewBox="0 0 24 24" class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                                <path
